from src.utils.reviewextractor import (
    check_product_urls,
    get_amazon_product_id,
    remove_html_code,
    get_amazon_link,
    extract_reviews_for_products,
)
import unittest
...
class AmazonUrlTest(unittest.TestCase):
    ...
    def test_review_extraction(self):
        ...
        self.assertRaises(
            Exception, extract_reviews_for_products, false_web_pages, 1, 3
        )
