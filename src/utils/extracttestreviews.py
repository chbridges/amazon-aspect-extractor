...
if __name__ == "__main__":
    """
    Used to extract 3000 Reviews for our self labeled training and test dataset of reviews
    """
    urls = [
        "https://www.amazon.com/-/de/dp/B081V6W99V/ref=sr_1_3?__mk_de_DE=%C3%85M%C3%85%C5%BD%C3%95%C3%91&dchild=1&keywords=laptop&qid=1612430596&sr=8-3",
    ...
    data = rw.extract_reviews_for_products(urls, 20, 6)
